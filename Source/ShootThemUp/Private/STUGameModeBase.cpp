...
void ASTUGameModeBase::StartRound()
{
    ...
    GetWorldTimerManager().SetTimer(GameRoundTimerHandle, this, &ASTUGameModeBase::GetTimerUpdate, 1.0f, true);
}
...
void ASTUGameModeBase::Killed(AController* KillerController, AController* VictimController)
{
    ...
    {
        STUUtils::AreEnemies(KillerController, VictimController) ? KillerPlayerState->AddKill() : KillerPlayerState->DecreaseKill();
    }
